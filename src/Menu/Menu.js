            ...
            collection: [
                {
                    name: "BREAKBEET",
                    price: "$32",
                    description: "Russian Standard Platinum , Raspberry & Beetroot Cordial, Lemon, Spicy Ginger "
                  },
                  {
                    name: "JAPANESE FIZZ",
                    price: "$26",
                    description: "Lemongrass Infused Russian Standard Platinum , Lime, Jasmine Green Tea & Matcha Soda"
                  },
                  {
                    name: "SGROPPINO",
                    price: "$37",
          ...
          <div className='landing-section-col-2-menu-slider-clicked'>
            ...
            <div className='landing-section-col-2-menu-slider-clicked-two'>
              <div className='landing-section-col-2-menu-slider-clicked-two-one'>
                <h4>CONTACT US</h4>
                <p>T. +212 690673259</p>
                <p>Ms. ghazalghizlan2479@gmail.com</p>
              </div>
              <div className='landing-section-col-2-menu-slider-clicked-two-two'>
              <h4>ADDRESS</h4>
                <p>Piazza Della Signoria, 15</p>
                <p>24563 . street Mekka .laayoune</p>
              </div>
            </div>
          </div>
        </div>
